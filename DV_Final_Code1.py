...
######################################################Data##############################################################
path = 'https://raw.githubusercontent.com/foazul/DV_FINAL_PROJECT/main/'
...
df_pivot = pd.read_csv(path + 'CO2_Emission_Continent_2_pivot.csv') #this dataframe was created based on the original one in order to calculate variations and means
