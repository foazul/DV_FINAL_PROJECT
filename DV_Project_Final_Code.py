...
df_pivot = pd.read_excel('CO2_Emission_Continent_2.xlsx') #this dataframe was created based on the original one in order to calculate variations and means
...
def plots(n_clicks, years, continents, calc):
 ...
 ############################################Bar Plot 2######################################################
    ...
    return go.Figure(data=data_scatter, layout=layout_scatter),            go.Figure(data=data_bar, layout=layout_bar),            go.Figure(data=data_bar2, layout=layout_bar2)
